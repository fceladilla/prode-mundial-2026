...
export default function PerfilPage({
  ...
  const backButton = (
    <motion.button
      ...
      onClick={() => router.back()}
      aria-label={t('back')}
      className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-carbon text-suave transition-colors hover:border-oro/40 hover:text-oro"
    >
      <svg
        width="18"
        height="18"
