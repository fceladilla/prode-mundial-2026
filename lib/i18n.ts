...
const es = {
  ...
  standingsLoading: 'Cargando posiciones...',
  standingsError: 'No se pudieron cargar las posiciones.',
  standingsEmpty: 'Todavía no hay posiciones disponibles.',
...
const ca: Dict = {
  ...
  navForum: 'Fòrum',
  navStandings: 'Posicions',
  // Classificacio (taula de posicions per grup)
  standingsTitle: 'Posicions per grup',
  standingsLoading: 'Carregant posicions...',
  standingsError: 'No s’han pogut carregar les posicions.',
  standingsEmpty: 'Encara no hi ha posicions disponibles.',
...
const en: Dict = {
  ...
  standingsError: 'Could not load standings.',
